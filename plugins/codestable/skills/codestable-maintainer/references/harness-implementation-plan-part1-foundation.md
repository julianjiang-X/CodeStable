...
`plugins/codestable/skills/cs-onboard/tools/codestable-doctor.py`. When CodeStable is onboarded into a
...
Implement the source script in CodeStable at
`plugins/codestable/skills/cs-onboard/tools/codestable-worktree-gate.py`. When CodeStable is onboarded
...
Implement the source script in CodeStable at
`plugins/codestable/skills/cs-onboard/tools/build-review-packet.py`. When CodeStable is onboarded into a
project, the runtime command path must be:
...
Implement the source script in CodeStable at `plugins/codestable/skills/cs-onboard/tools/plan-commits.py`.
