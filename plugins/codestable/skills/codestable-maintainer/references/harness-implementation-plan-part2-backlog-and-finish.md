...
`plugins/codestable/skills/cs-onboard/tools/codestable-backlog.py`. When CodeStable is onboarded into a
...
```bash
python3 plugins/codestable/skills/codestable-maintainer/tools/verify.py --branch <branch> --remote origin
```
