...
req 是能力愿景层，但 accept 阶段不直接自由改长期 requirement。对照方案
frontmatter 的 `requirement`、第 1 节需求摘要、feature 目录下已有
`*-req-delta.md` 和 clarifications：
...
这是**受 delta 约束的实际写文件动作**。不能把 accept 当成自由重写
requirements 的机会。
